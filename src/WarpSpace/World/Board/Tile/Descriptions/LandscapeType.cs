...
namespace WarpSpace.World.Board.Tile.Descriptions
{
    public static class LandscapeTypeExtensions
    {
        ...
        public static bool IsPassableWith(this LandscapeType landscape, ChassisType chassis)
        {
            return landscape.GetPassability(chassis) != Passability.None;
        }
        
        public static Passability GetPassability(this LandscapeType type, ChassisType chassis)
        {
            switch (chassis)
            {
                case ChassisType.Mothership:
                    switch (type)
                    {
