...
namespace Lanski.Structures
{
    ...
    public struct Or<T1, T2, T3, T4, T5, T6, T7>: IEquatable<Or<T1, T2, T3, T4, T5, T6, T7>>
    {
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T1 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T2 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T3 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T4 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T5 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T6 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        public static implicit operator Or<T1, T2, T3, T4, T5, T6, T7>(T7 v) => new Or<T1, T2, T3, T4, T5, T6, T7>(v);
        ...
        [Pure] public bool is_a_T5(out T5 v) => _v5.has_a_Value(out v);
        [Pure] public bool is_a_T6(out T6 v) => _v6.has_a_Value(out v);
        [Pure] public bool is_a_T7(out T7 v) => _v7.has_a_Value(out v);
        ...
        [Pure] public bool is_a_T5() => _v5.has_a_Value();
        [Pure] public bool is_a_T6() => _v6.has_a_Value();
        [Pure] public bool is_a_T7() => _v7.has_a_Value();
        ...
        [Pure] public Possible<T5> as_a_T5() => _v5;
        [Pure] public Possible<T6> as_a_T6() => _v6;
        [Pure] public Possible<T7> as_a_T7() => _v7;
        ...
        [Pure] public T5 must_be_a_T5() => _v5.must_have_a_Value();
        [Pure] public T6 must_be_a_T6() => _v6.must_have_a_Value();
        [Pure] public T7 must_be_a_T7() => _v7.must_have_a_Value();

        [Pure]public bool Equals(Or<T1, T2, T3, T4, T5, T6, T7> other) => 
            _v1.Equals(other._v1) && 
            _v2.Equals(other._v2) && 
            _v3.Equals(other._v3) && 
            _v4.Equals(other._v4) && 
            _v5.Equals(other._v5) &&
            _v6.Equals(other._v6) &&
            _v7.Equals(other._v7)
        ;

        [Pure]public bool has_the_Same_Type_As(Or<T1, T2, T3, T4, T5, T6, T7> the_other) =>
            _v1.has_a_Value() && the_other._v1.has_a_Value() ||
            _v2.has_a_Value() && the_other._v2.has_a_Value() ||
            _v3.has_a_Value() && the_other._v3.has_a_Value() ||
            _v4.has_a_Value() && the_other._v4.has_a_Value() ||
            _v5.has_a_Value() && the_other._v5.has_a_Value() ||
            _v6.has_a_Value() && the_other._v6.has_a_Value() ||
            _v7.has_a_Value() && the_other._v7.has_a_Value()
        ;
        ...
        public override string ToString()
        {
            ...
            if (is_a_T5(out var v5)) return v5.ToString();
            if (is_a_T6(out var v6)) return v6.ToString();
            if (is_a_T7(out var v7)) return v7.ToString();
            throw new InvalidOperationException("Unknown variant");
        }
