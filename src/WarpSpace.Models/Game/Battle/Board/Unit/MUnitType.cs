...
namespace WarpSpace.Models.Game.Battle.Board.Unit
{
    public class MUnitType
    {
        ...
        public MUnitType(string the_name, int the_total_hit_points, int the_total_moves, MWeaponType the_weapon_type, MChassisType the_chassis_type, DStuff the_remains, DStuff the_initial_inventory_content, bool the_can_dock, bool the_can_exit, char the_serialization_symbol)
        {
            s_Name = the_name;
