...
namespace WarpSpace.Models.Game.Battle.Board.Unit
{
    ...
    {
        public MLocation(Or<MTile, MBay> the_owner): this(the_owner, Possible.Empty<MUnit>()) {}
        public MLocation(Or<MTile, MBay> the_owner, Possible<MUnit> the_possible_unit)
        {
            its_owner = the_owner;
            its_possible_unit = the_possible_unit;
        }

        public bool is_Adjacent_To(MLocation the_other) => 
            this.is_a_Tile(out var its_tile) 
