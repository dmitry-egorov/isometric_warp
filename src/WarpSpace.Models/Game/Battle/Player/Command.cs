...
namespace WarpSpace.Models.Game.Battle.Player
{
    public struct Command
    {
        public static class Create
        {
            ...
            public static Command Move(MUnit unit, MLocation destination) => new Command { _variant = new Move(unit, destination) };
        ...
        public bool is_a_Tile_Move_Command()    => is_a_Move_Command(out var the_move_command) && the_move_command.is_Tile_Move();
        public bool is_a_Dock_Command() => is_a_Move_Command(out var the_move_command) && !the_move_command.is_Tile_Move();
        ...
        public struct Move
        {
            ...
            public bool is_Tile_Move() => Destination.is_a_Tile() && Unit.is_At_a_Tile();
        }
