...
namespace Lanski.Reactive
{
    ...
    {
        public static T Must_Have_a_Value<T>(this ICell<Possible<T>> cell) => cell.Value.Must_Have_a_Value();
        public static bool Has_a_Value<T>(this ICell<Possible<T>> cell, out T obj) => cell.Value.Has_a_Value(out obj);
