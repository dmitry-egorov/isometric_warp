...
namespace WarpSpace.Descriptions
{
    public struct StructureDescription
    {
        ...
        public static class Create
        {
            ...
            public static StructureDescription Debris(Direction2D orientation, InventoryContent? loot) => new StructureDescription(orientation) { _variant = new Debris(loot) };            
        }
        ...
        public struct Debris
        {
            ...
            public Debris(InventoryContent? possible_loot) => Loot = possible_loot;
        }
